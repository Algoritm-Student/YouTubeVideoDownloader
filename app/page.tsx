...
type FeedstockKey = (typeof FEEDSTOCK)[number]["key"];

type CalcState = {
  feedstockKey: FeedstockKey;
  kgPerDay: number;
  gasPriceUZS: number;
  electricityPriceUZS: number;
};
...
function estimate({
  ...
  const capex = Math.max(12_000_000, biogas_m3 * 1_200_000);
  const payback_months = monthly_saving > 0 ? capex / monthly_saving : Infinity;

  const co2_kg_per_day = biogas_m3 * 1.9;
...
const PRICING = [
  {
    name: "Starter",
    price: "Kichik hajm",
    bullets: ["Mini reaktor (demo)", "Bazaviy xavfsizlik", "O‘rnatish bo‘yicha yo‘riqnoma", "1 oylik servis"],
    accent: false
  },
  {
    name: "Standard",
    price: "Eng mashhur",
    bullets: ["O‘rtacha quvvat", "Gaz tozalash moduli", "Sensorlar + monitoring (demo)", "3 oylik servis"],
    accent: true
  },
  {
    name: "Pro",
    price: "Korxona darajasi",
    bullets: ["Katta quvvat", "Generator integratsiyasi (ixtiyoriy)", "Remote dashboard (demo)", "12 oylik servis"],
    accent: false
  }
];
      ...
      <main className="mx-auto max-w-6xl px-4 pb-20 pt-10 sm:px-6 sm:pt-14">
            ...
            <Card className="relative overflow-hidden p-5 sm:p-6">
              ...
              <div className="relative">
                ...
                <div className="grid gap-3 sm:grid-cols-3">
                  ...
                  <MiniKpi title="Tejam" value={moneyUZS(result.monthly_saving)} icon={LineChart} />
                </div>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <AreaChart data={chartData} margin={{ top: 10, right: 10, left: -18, bottom: 0 }}>
                        ...
                        <Tooltip
                          ...
                          formatter={(v) => [moneyUZS(Number(v)), "Kumulyativ"]}
                          labelFormatter={(l) => `${l}-oy`}
                        />
                        <Area type="monotone" dataKey="cum" stroke="currentColor" fill="url(#c)" strokeWidth={2} />
                      </AreaChart>
                    </ResponsiveContainer>
                  </div>
                </div>
        ...
        <section id="solution" className="mt-16 scroll-mt-24">
          <SectionTitle
            ...
            subtitle="Startup taqdimoti uchun: foyda, raqamlar, vizual ishonch."
          />
        ...
        <section id="how" className="mt-16 scroll-mt-24">
          <SectionTitle
            ...
            subtitle="Oddiy, tushunarli. Har bosqichda xavfsizlik va samaradorlik."
          />
        ...
        <section id="calc" className="mt-16 scroll-mt-24">
          <SectionTitle
            ...
            subtitle="Bu demo model, real loyihada audit bilan aniqlashtiriladi."
          />
          ...
          <div className="mt-10 grid gap-4 lg:grid-cols-5">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      setCalc((p) => ({ ...p, feedstockKey: e.target.value as FeedstockKey }))
                    }
                  >
                    {FEEDSTOCK.map((x) => (
                ...
                <Button variant="soft" onClick={() => notify("Natijalar yangilandi ✅")} className="w-full">
                  Natijani yangilash
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Button>

                <p className="text-xs leading-relaxed text-black/50">
                  * Bu kalkulyator demo. Real loyiha: xomashyo tarkibi, harorat, reaktor hajmi va generator
            ...
            <Card className="p-6 lg:col-span-3">
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <ResultTile label="Payback" value={result.payback_months ? `${result.payback_months} oy` : "—"} hint="taxmin" icon={Gauge} />
              </div>
            </Card>
          </div>
        </section>
        ...
        <section id="cases" className="mt-16 scroll-mt-24">
          <SectionTitle
            ...
            subtitle="3–6 ta case yetarli. Bu bo‘lim ishonch beradi."
          />
        ...
        <section id="pricing" className="mt-16 scroll-mt-24">
          <SectionTitle
            ...
            subtitle="Narxni keyin real auditdan keyin yozishingiz mumkin."
          />
        ...
        <section id="faq" className="mt-16 scroll-mt-24">
          <SectionTitle
            ...
            subtitle="Bu bo‘lim ishonchni oshiradi."
          />
          ...
          <div className="mt-10 grid gap-4 lg:grid-cols-2">
                ...
                {FAQ.map((x, i) => {
                  ...
                  return (
                    <div key={x.q} className="rounded-2xl border border-black/5 bg-white/60">
                      ...
                      {open ? <div className="px-4 pb-4 text-sm text-black/60">{x.a}</div> : null}
                    </div>
                  );
                })}
              </div>
            ...
            <Card className="p-6">
              ...
              <ul className="space-y-3 text-sm text-black/70">
                <li className="flex gap-2"><Check className="mt-0.5 h-4 w-4" /> Muammo → yechim → natija</li>
                <li className="flex gap-2"><Check className="mt-0.5 h-4 w-4" /> Raqamlar: m³/kWh/ROI</li>
                <li className="flex gap-2"><Check className="mt-0.5 h-4 w-4" /> Case studies</li>
                <li className="flex gap-2"><Check className="mt-0.5 h-4 w-4" /> Paketlar, servis, kafolat</li>
                <li className="flex gap-2"><Check className="mt-0.5 h-4 w-4" /> CTA: ariza, telefon, Telegram/WhatsApp</li>
              </ul>
            </Card>
          </div>
        </section>
        ...
        <section id="contact" className="mt-16 scroll-mt-24">
          <SectionTitle
            ...
            subtitle="Kontakt formni to‘ldiring — mos konfiguratsiya tavsiya qilamiz."
          />
...
function MiniKpi({ title, value, icon: Icon }: { title: string; value: string; icon: LucideIcon }) {
  return (
